...
export function fetchingSearch(searchText) {
	return {
...
export function fetchingSearchFailure(error) {
	return {
...
export function fetchingSearchSuccess(newJokes, totalJokes) {
	return {
...
export function fetchAndHandleSearch(searchText) {
	return function(dispatch, getState) {
		...
		return getSearchResults(searchText, currentPage)
			.then(data => {
